...
!function (e) {
  function o(e, o) {
    var s = e.split("/");this.user = s[0], this.repo = s[1], this.full_name = e, this.gh = new GitHub({ token: o });
  }var s = { get: function get(e, o) {
      var s = this.colors[e];return s || (o === !1 ? null : { color: "#ccc" });
  ...
  o.prototype.getAllRepos = function (e) {
    var o = this;return o.gh.get("users/" + o.user + "/repos", { all: !0 }, function (o, s) {
      return o ? e(o) : (s = s.filter(function (e) {
        return !e.fork;
      }), s.length || e(new Error("This user doesn't have any repositories.")), void e(null, s));
    });
  }, o.prototype.repoStats = function (e) {
    return this.gh.get("repos/" + this.full_name + "/languages", this.check(e));
  }, o.prototype.userStats = function (e) {
    return this.getAllRepos(this.check(e));
  }, o.prototype.check = function (e) {
    return function (o, t) {
      if (o) return e(o);var r = {},
          a = [];Array.isArray(t) ? (t.forEach(function (e) {
        r[e.language] = r[e.language] || 0, ++r[e.language];
      }), r["null"] && (r.Others = r["null"], delete r["null"])) : r = t, a = Object.keys(r).map(function (e) {
        return { label: e, value: r[e], color: s.get(e).color };
      }), e(null, a.sort(function (e, o) {
        return e.value < o.value ? 1 : -1;
      }));
    };
  }, e.GitHubPolyglot = o;
}(window);